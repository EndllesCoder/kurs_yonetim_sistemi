...
if($_SERVER["REQUEST_METHOD"]=="POST"){ 
  ...
  if(empty($_POST["aciklama"])){
    $aciklamaErr = "açıklama alanı gereklidir.";
  }
  else{
  ...
  if(empty($baslikErr) && empty($altbaslikErr) && empty($resimErr) && empty($aciklamaErr)){
     if(editCourse($id,$baslik,$altbaslik,$aciklama,$resim,$onay,$anasayfa)){
      ...
      $_SESSION["message"] = $baslik ." adlı kurs güncellendi.";
        ...
        <div class="row">
            <div class="col-9">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="aciklama" id="aciklama"  class="form-control"><?php echo $selectedCourse["aciklama"]; ?></textarea>
            ...
            <div class="col-3">
               <img src="img/<?php echo $selectedCourse["resim"]; ?>" style="width: 150px;" class="img-fluid" alt="">
               <hr>
